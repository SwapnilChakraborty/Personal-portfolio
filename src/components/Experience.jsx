  ...
  return (
    <div className="bg-gradient-to-b from-gray-800 to-black w-full h-screen text-white">
      <div className="max-w-screen-lg mx-auto p-4 sm:p-8 flex flex-col justify-center w-full h-full">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-4 sm:px-12">
          {skills.map(({ id, icon, name }) => (
            <div
              key={id}
              className="shadow-md hover:scale-105 duration-500 py-4 rounded-lg bg-gray-700"
            >
